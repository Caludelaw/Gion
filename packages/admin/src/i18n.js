...
function detectLang() {
  ...
  if (typeof window !== 'undefined' && window.__GION_LANG__ && messages[window.__GION_LANG__]) return window.__GION_LANG__;
...
function setLocale(code) {
  if (messages[code]) {
    ...
    try { localStorage.setItem('gion_lang', code); } catch {}
  }
}
